...
class TestRooms:
    """
    Class to test Room API endpoints
    """
    ...
    def test_get_all_rooms(self, _log_test_names):
        """
    ...
    @allure.tag("Room", "Get")
    @pytest.mark.acceptance
    def test_get_room(self, create_room, _log_test_names):
        """
    ...
    @pytest.mark.acceptance
    def test_create_room(self, _log_test_names):
        """
        Test create room
        """
    ...
    @pytest.mark.acceptance
    def test_update_room(self, create_room, _log_test_names):
        """
        Test update room
        :param create_room: fixture to create a room
        """
    ...
    @pytest.mark.acceptance
    def test_delete_room(self, create_room, _log_test_names):
        """
        Test delete room
        :param create_room: fixture to create a room
        """
