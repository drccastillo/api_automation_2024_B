...
class TestMessages:
    """
    Class to test Message API endpoints
    """
    ...
    def test_get_all_messages(self, _log_test_names):
        """
    ...
    @allure.tag("Message", "Get")
    @pytest.mark.acceptance
    def test_get_message(self, create_message, _log_test_names):
        """
        Test get message endpoint
        :param create_message: fixture to create a message
        """
    ...
    @allure.tag("Message", "Get")
    @pytest.mark.acceptance
    def test_get_unread_messages(self, _log_test_names):
        """
    ...
    @pytest.mark.acceptance
    def test_create_message(self, _log_test_names):
        """
        Test create message
        """
    ...
    @pytest.mark.acceptance
    def test_mark_message_as_read(self, create_message, _log_test_names):
        """
    ...
    @pytest.mark.acceptance
    def test_delete_message(self, create_message, _log_test_names):
        """
        Test delete message
        :param create_message: fixture to create a message
        """
