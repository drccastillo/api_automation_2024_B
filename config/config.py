...
headers_booker = {}
body_credential_booker = {
    "username" : user_booker_api,
    "password" : password_booker_api
}
...
if auth_response.status_code == 200:
    ...
    LOGGER.error("Authentication failed with status code: %s", auth_response.status_code)
